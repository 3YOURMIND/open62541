...
function(ua_generate_nodeid_header)
    ...
    add_custom_command(OUTPUT ${UA_GEN_ID_OUTPUT_DIR}/${UA_GEN_ID_NAME}.h
        PRE_BUILD
        COMMAND Python3::Interpreter ${open62541_TOOLS_DIR}/generate_nodeid_header.py
...
function(ua_generate_datatypes)
    ...
    add_custom_command(OUTPUT ${UA_GEN_DT_OUTPUT_DIR}/${UA_GEN_DT_NAME}_generated.c
        ...
        PRE_BUILD
        COMMAND ${ARG_CONV_EXCL_ENV} Python3::Interpreter ${open62541_TOOLS_DIR}/generate_datatypes.py
        ${NAMESPACE_MAP_TMP}
        ${SELECTED_TYPES_TMP}
        ${BSD_FILES_TMP}
        ${IMPORT_BSD_TMP}
...
function(ua_generate_nodeset)
    ...
    add_custom_command(OUTPUT ${UA_GEN_NS_OUTPUT_DIR}/namespace${FILE_SUFFIX}.c
                       ...
                       PRE_BUILD
                       COMMAND Python3::Interpreter ${open62541_TOOLS_DIR}/nodeset_compiler/nodeset_compiler.py
